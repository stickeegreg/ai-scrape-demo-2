...
class ScrapeTypeFactory
{
    public function create(ScrapeType $scrapeType, string $prompt, ScrapeRun $scrapeRun): ScrapeTypeInterface
    {
        return match ($scrapeType) {
            ...
            ScrapeType::WalletPayPal => new WalletPayPalScrapeType($prompt, $scrapeRun, 123, ScrapeContext::DesktopWeb, 'https://www.amazon.co.uk', false, 'UK'), // TODO: replace 123 with the actual URL ID
